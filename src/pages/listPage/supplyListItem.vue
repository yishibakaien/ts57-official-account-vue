<template>
	<div class="content-wrap">
		<div class="title clearFix">
			<img class="fl" :src="item.userHeadIcon" v-errorImg alt="厂家头像"/>
			<span class="fl">{{item.userName}}</span>
		</div>
		<border :styleData="styleData"></border>
		<div class="content clearFix">
			<img class="fl" :src="item.productPicUrl?item.productPicUrl:'/static/images/default/morenhuaxing.png'" alt="花型图片"/>
			<div class="info fl">
